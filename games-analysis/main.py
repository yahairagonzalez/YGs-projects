...
plt.scatter(df_main["first_release_date"], df_main["critic_rating_value"], color = "pink", label = "Critic Ratings")

plt.scatter(df_main["first_release_date"], df_main["user_rating_value"], color = "blue", label = "User Ratings")
